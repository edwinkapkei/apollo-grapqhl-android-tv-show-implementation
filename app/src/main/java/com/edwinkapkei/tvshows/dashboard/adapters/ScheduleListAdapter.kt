...
class ScheduleListAdapter(private var shows: List<GetScheduleQuery.Schedule>) : RecyclerView.Adapter<ScheduleListAdapter.ViewHolder>() {

    var endOfListReached: (() -> Unit)? = null
    var onItemClicked: ((GetScheduleQuery.Schedule) -> Unit)? = null
